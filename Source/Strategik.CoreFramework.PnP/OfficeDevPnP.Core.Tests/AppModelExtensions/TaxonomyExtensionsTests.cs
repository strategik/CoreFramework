...
namespace Microsoft.SharePoint.Client.Tests
{
    ...
    public class TaxonomyExtensionsTests
    {
        ...
        #endregion Create taxonomy field tests
        ...
        #endregion Get taxonomy object tests
