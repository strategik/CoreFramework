...
namespace Microsoft.SharePoint.Client.Tests
{
    ...
    {
        private const string DOC_LIB_TITLE = "Test_Library";
        private const string TEST_CATEGORY = "Fields and Content Types";
        private const string TEST_CT_PNP = "Test_CT_PNP";
        private const string TEST_CT_PNP_ID = "0x01010080BA6ECAEDA6487EAD28FC3C21CA1900";
	...
	<FieldRefs>
	  ...
	  <FieldRef ID=""{fa564e0f-0c70-4ab9-b863-0177e6ddd247}"" Name=""Title"" DisplayName=""Test"" Required=""TRUE"" Sealed=""TRUE""/>
        ...
        private void EmptyRecycleBin(ClientContext clientContext)
        {
