...
namespace OfficeDevPnP.Core.Tests.AppModelExtensions
{
    ...
    {
        private static string CurrentDynamicChildLimit = "__CurrentDynamicChildLimit";
        private static string GlobalDynamicChildLimit = "__GlobalDynamicChildLimit";

        #region Test initialize and cleanup

        private static bool deactivateSiteFeatureOnTeardown = false;
        private static bool deactivateWebFeatureOnTeardown = false;
        private static Guid publishingSiteFeatureId = new Guid("f6924d36-2fa8-4f0b-b16d-06b7250180fa");
        private static Guid publishingWebFeatureId = new Guid("94c94ca6-b32f-4da9-a9e3-1f3d343d7ecb");
        ...
        #endregion Area navigation settings tests (AreaNavigationSettings.aspx) / only applies to publishing sites
    }
}