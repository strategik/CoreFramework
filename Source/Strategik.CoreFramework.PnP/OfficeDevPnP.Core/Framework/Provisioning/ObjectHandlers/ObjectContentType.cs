...
namespace OfficeDevPnP.Core.Framework.Provisioning.ObjectHandlers
{
    public class ObjectContentType : ObjectHandlerBase
    {
        ...
        private static void UpdateContentType(Web web, ContentType existingContentType, Model.ContentType templateContentType)
        {
            var isDirty = false;
        ...
        private static ContentType CreateContentType(Web web, Model.ContentType templateContentType)
        {
