...
namespace OfficeDevPnP.Core.Framework.TimerJobs
{
    ...
    public class TimerJobRunEventArgs : EventArgs
    {
        ...
        internal TimerJobRunEventArgs(string url, ClientContext ccSite, ClientContext ccWeb, ClientContext ccTenant, string configurationData)
            : this(url, ccSite, ccWeb, ccTenant, null, null, null, null, configurationData)
        {
        }
