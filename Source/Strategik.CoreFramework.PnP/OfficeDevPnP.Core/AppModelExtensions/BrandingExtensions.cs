...
namespace Microsoft.SharePoint.Client
{
    ...
    public static partial class BrandingExtensions
    {
        ...
        private const string AvailableWebTemplates = "__WebTemplates";
        private const string InheritWebTemplates = "__InheritWebTemplates";
        private const string InheritMaster = "__InheritMasterUrl";
        private const string InheritCustomMaster = "__InheritCustomMasterUrl";
        private const string InheritTheme = "__InheritsThemedCssFolderUrl";
        private const string Inherit = "__Inherit";
        ...
        public static ListItem GetPageLayoutListItemByName(this Web web, string pageLayoutName)
        {
            ...
            pageLayoutName = path + Path.GetFileNameWithoutExtension(pageLayoutName);
