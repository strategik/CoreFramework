...
namespace Microsoft.SharePoint.Client
{
    ...
    {
        private const string SharePointNamespaceName = "http://schemas.microsoft.com/sharepoint/";
        ...
        /// </summary>
        private static void ProvisionModuleInternal(this Web web, string baseFolder, XElement moduleXml)
        {
        ...
        /// </summary>
        private static File ProvisionFileInternal(this Web web, string baseUrl, string baseFolder, XElement fileXml, bool useWebDav = true)
        {
