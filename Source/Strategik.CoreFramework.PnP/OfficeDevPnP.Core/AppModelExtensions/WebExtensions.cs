...
namespace Microsoft.SharePoint.Client
{
    ...
    {
        private const string MSG_CONTEXT_CLOSED = "ClientContext gets closed after action is completed. Calling ExecuteQuery again returns an error. Verify that you have an open ClientContext object.";
        private const string SITE_STATUS_ACTIVE = "Active";
        private const string SITE_STATUS_CREATING = "Creating";
        private const string SITE_STATUS_RECYCLED = "Recycled";
        private const string INDEXED_PROPERTY_KEY = "vti_indexedpropertykeys";
        ...
        #endregion Web (site) query, creation and deletion
        ...
        #endregion Apps and sandbox solutions
        ...
        #endregion Site retrieval via search
        ...
        #endregion Web (site) Property Bag Modifiers
