...
namespace Microsoft.SharePoint.Client
{
    ...
    public static partial class NavigationExtensions
    {
        ...
        private const string PublishingFeatureActivated = "__PublishingFeatureActivated";
        private const string WebNavigationSettings = "_webnavigationsettings";
        private const string CurrentNavigationIncludeTypes = "__CurrentNavigationIncludeTypes";
        private const string CurrentDynamicChildLimit = "__CurrentDynamicChildLimit";
        private const string GlobalNavigationIncludeTypes = "__GlobalNavigationIncludeTypes";
        private const string GlobalDynamicChildLimit = "__GlobalDynamicChildLimit";
        private const string NavigationOrderingMethod = "__NavigationOrderingMethod";
        private const string NavigationAutomaticSortingMethod = "__NavigationAutomaticSortingMethod";
        private const string NavigationSortAscending = "__NavigationSortAscending";
        private const string NavigationShowSiblings = "__NavigationShowSiblings";
        ...
        public static void UpdateNavigationSettings(this Web web, AreaNavigationEntity navigationSettings)
        {
            ...
            web.Context.ExecuteQueryRetry();
            WebNavigationSettings webNav = new WebNavigationSettings(web.Context, web);
        ...
        #endregion Area Navigation (publishing sites)
        ...
        #endregion Navigation elements - quicklaunch, top navigation, search navigation
